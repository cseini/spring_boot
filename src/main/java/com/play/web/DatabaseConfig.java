...
@MapperScan(basePackages="com.play.web.mapper")
@ComponentScan(basePackages="com.play.web.mapper")
public class DatabaseConfig {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource ds) throws Exception {
		...
		sf.setMapperLocations(rs.getResources("classpath:com/play/web/mapper/*.xml"));
		return sf.getObject();
	}
	@Bean
